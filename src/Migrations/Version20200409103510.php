 ...
 */
final class Version20200409103510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipo ADD COLUMN goles_favor INTEGER DEFAULT NULL');
        $this->addSql('ALTER TABLE equipo ADD COLUMN goles_contra INTEGER DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__entrenador');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FD19603B23BFBED ON entrenador (equipo_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__equipo AS SELECT id, nombre, escudo, descripcion, puntos FROM equipo');
        $this->addSql('DROP TABLE equipo');
        $this->addSql('CREATE TABLE equipo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre VARCHAR(150) NOT NULL, escudo VARCHAR(255) NOT NULL, descripcion CLOB DEFAULT NULL, puntos INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO equipo (id, nombre, escudo, descripcion, puntos) SELECT id, nombre, escudo, descripcion, puntos FROM __temp__equipo');
