 ...
 */
final class Version20200413062051 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, foto FROM user');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, foto VARCHAR(255) DEFAULT NULL COLLATE BINARY, texto CLOB DEFAULT NULL, CONSTRAINT FK_8D93D64923BFBED FOREIGN KEY (equipo_id) REFERENCES equipo (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user (id, email, roles, password, foto) SELECT id, email, roles, password, foto FROM __temp__user');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , password VARCHAR(255) NOT NULL, foto VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, foto) SELECT id, email, roles, password, foto FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
