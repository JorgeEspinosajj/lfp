 ...
 */
final class Version20200324111401 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__partidos AS SELECT id, equipo_local_id, equipo_visitante_id, goles_local, goles_visitante, resultado FROM partidos');
        $this->addSql('DROP TABLE partidos');
        $this->addSql('CREATE TABLE partidos (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, equipo_local_id INTEGER NOT NULL, equipo_visitante_id INTEGER NOT NULL, goles_local INTEGER DEFAULT NULL, goles_visitante INTEGER DEFAULT NULL, resultado VARCHAR(200) DEFAULT NULL COLLATE BINARY, resultado_v VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_8C926FF688774E73 FOREIGN KEY (equipo_local_id) REFERENCES equipo (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_8C926FF68C243011 FOREIGN KEY (equipo_visitante_id) REFERENCES equipo (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO partidos (id, equipo_local_id, equipo_visitante_id, goles_local, goles_visitante, resultado) SELECT id, equipo_local_id, equipo_visitante_id, goles_local, goles_visitante, resultado FROM __temp__partidos');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__partidos AS SELECT id, equipo_local_id, equipo_visitante_id, goles_local, goles_visitante, resultado FROM partidos');
        $this->addSql('DROP TABLE partidos');
        $this->addSql('CREATE TABLE partidos (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, equipo_local_id INTEGER NOT NULL, equipo_visitante_id INTEGER NOT NULL, goles_local INTEGER DEFAULT NULL, goles_visitante INTEGER DEFAULT NULL, resultado VARCHAR(200) DEFAULT NULL)');
        $this->addSql('INSERT INTO partidos (id, equipo_local_id, equipo_visitante_id, goles_local, goles_visitante, resultado) SELECT id, equipo_local_id, equipo_visitante_id, goles_local, goles_visitante, resultado FROM __temp__partidos');
        $this->addSql('DROP TABLE __temp__partidos');
        $this->addSql('CREATE INDEX IDX_8C926FF688774E73 ON partidos (equipo_local_id)');
        $this->addSql('CREATE INDEX IDX_8C926FF68C243011 ON partidos (equipo_visitante_id)');
