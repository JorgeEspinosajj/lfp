 ...
 */
final class Version20200415142923 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_4B91E70214D45BBE');
        $this->addSql('CREATE TEMPORARY TABLE __temp__comentario AS SELECT id, autor_id, arg FROM comentario');
        $this->addSql('DROP TABLE comentario');
        $this->addSql('CREATE TABLE comentario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, autor_id INTEGER NOT NULL, arg CLOB NOT NULL COLLATE BINARY, likes INTEGER DEFAULT NULL, CONSTRAINT FK_4B91E70214D45BBE FOREIGN KEY (autor_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comentario (id, autor_id, arg) SELECT id, autor_id, arg FROM __temp__comentario');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comentario AS SELECT id, autor_id, arg FROM comentario');
        $this->addSql('DROP TABLE comentario');
        $this->addSql('CREATE TABLE comentario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, autor_id INTEGER NOT NULL, arg CLOB NOT NULL)');
        $this->addSql('INSERT INTO comentario (id, autor_id, arg) SELECT id, autor_id, arg FROM __temp__comentario');
        $this->addSql('DROP TABLE __temp__comentario');
        $this->addSql('CREATE INDEX IDX_4B91E70214D45BBE ON comentario (autor_id)');
        $this->addSql('DROP INDEX UNIQ_FD19603B23BFBED');
