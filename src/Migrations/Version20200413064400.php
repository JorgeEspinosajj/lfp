 ...
 */
final class Version20200413064400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comentario AS SELECT id, autor_id FROM comentario');
        $this->addSql('DROP TABLE comentario');
        $this->addSql('CREATE TABLE comentario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, autor_id INTEGER NOT NULL, arg CLOB NOT NULL, CONSTRAINT FK_4B91E70214D45BBE FOREIGN KEY (autor_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comentario (id, autor_id) SELECT id, autor_id FROM __temp__comentario');
